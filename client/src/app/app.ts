...
export class App {
    public static bootstrap():void {
        ...
        appModule.config(["$urlRouterProvider", "$stateProvider", "$translateProvider", "$locationProvider", "$httpProvider",
        ($urlRouterProvider:IUrlRouterProvider, $stateProvider:IStateProvider, $translateProvider:ITranslateProvider,
         $locationProvider: ILocationProvider, $httpProvider:IHttpProvider):any => {
