...
The main.css and vendor.css files allow to cleanly separate what belongs to the application and what comes from third parties. The production build will process those files separately and all the files imported in those will be inlined/bundled.
